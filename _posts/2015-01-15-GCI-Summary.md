...
This led my to create a whole new [wiki entry][Modulus Wiki] on the process which enabled further GCI participantes to get Modulus set up and was linked to from the Github Repo's. 

The write-up of all improvements has its own [wiki page][Modulus Algorithm Wiki]. It was my first experience with the grails plugin, Searchable, which is built on Apache Lucene. I made a few improvements and submitted a pull request, which might be merged at the end of GCI. 
...
<img src="/assets/GCISummary/JSON.png" alt="JSON" style="width: 600px;"/>
<img src="/assets/GCISummary/ModulusUI.png" alt="UI additions" style="width: 600px;"/>
...
<img src="/assets/GCISummary/Delete Link.png" alt="Delete link" style="width: 600px;"/>
